...
for (i in 1:length(AvailableSeries)) {
  ...
  assign( paste0("dsn.race.mexam.", i), subset(dsn.race.mexam, SDDSRVYR == AvailableSeries[i]))
  ...
  assign( paste0("surv.all.coef.", i), lapply(eval(parse(text=paste0("surv.all.raw.", i))), function(x) { tryCatch({ coef(summary(x)) }, error=function(e){}) }) ) # list of df
