...
xmeta2df <- function(x) {
  ...
  for (i in x) {
    ### metafor extraction
    # overall effect, lower CI 95%, upper CI 95%, p-value, tau2, I2
    meta.final <- rbind(meta.final, c(i$b, i$ci.lb, i$ci.ub, i$pval, i$I2))
  }
  rownames(meta.final) <- names(x)
  colnames(meta.final) <- c("Effect", "Lower", "Upper", "p", "I2") # label metafor analysis
  ...
  return(meta.final[, c("var_desc", "Effect", "CI", "p", "I2")]) # reorder df as it's returned
}
```
